...
{
    /// <summary>
    /// A generic tool view model handling selection, used to share some data of the linked CR document.
    /// </summary>
    public partial class ExtendedViewModelBase : ObservableObject/*, ISelector*/
    {
        [ObservableProperty]
        ...
        protected ExtendedViewModelBase(string id/*, IEventAggregator? eventAggregator = null*/, ISelectionService selectionService = null)
        {
            ...
            _selectionService.SelectedUnitChanged += OnUnitChanged;
            HasDocument = false;
         ...
         private void OnUnitChanged(DataBlock? newUnit)
        {
            // Votre logique de MakeItems ici
        }
